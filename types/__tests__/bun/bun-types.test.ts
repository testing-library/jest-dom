...
expect(element).toHaveActiveDescendant()
expect(element).toHaveActiveDescendant(document.body)
expect(element).toHaveActiveDescendant('id')
...
expect(element).toContainAnyByAltText('profile photo')
expect(element).toContainOneByAltText('profile photo')
expect(element).toContainAnyByDisplayValue('Option A')
expect(element).toContainOneByDisplayValue('Option A')
expect(element).toContainAnyByLabelText('Full name')
expect(element).toContainOneByLabelText('Full name')
expect(element).toContainAnyByPlaceholderText('Enter name')
expect(element).toContainOneByPlaceholderText('Enter name')
expect(element).toContainAnyByRole('button')
expect(element).toContainOneByRole('button')
expect(element).toContainAnyByRole('heading', {name: 'Welcome'})
expect(element).toContainOneByRole('heading', {name: 'Welcome'})
expect(element).toContainAnyByTestId('submit')
expect(element).toContainOneByTestId('submit')
expect(element).toContainAnyByText('Submit')
expect(element).toContainOneByText('Submit')
expect(element).toContainAnyByTitle('Page title')
expect(element).toContainOneByTitle('Page title')
...
expect(element).not.toHaveActiveDescendant()
expect(element).not.toHaveActiveDescendant(document.body)
expect(element).not.toHaveActiveDescendant('id')
expect(element).not.toHaveVirtualFocus()
...
expect(element).not.toContainAnyByAltText('profile photo')
expect(element).not.toContainOneByAltText('profile photo')
expect(element).not.toContainAnyByDisplayValue('Option A')
expect(element).not.toContainOneByDisplayValue('Option A')
expect(element).not.toContainAnyByLabelText('Full name')
expect(element).not.toContainOneByLabelText('Full name')
expect(element).not.toContainAnyByPlaceholderText('Enter name')
expect(element).not.toContainOneByPlaceholderText('Enter name')
expect(element).not.toContainAnyByRole('button')
expect(element).not.toContainOneByRole('button')
expect(element).not.toContainAnyByTestId('submit')
expect(element).not.toContainOneByTestId('submit')
expect(element).not.toContainAnyByText('Submit')
expect(element).not.toContainOneByText('Submit')
expect(element).not.toContainAnyByTitle('Page title')
expect(element).not.toContainOneByTitle('Page title')
