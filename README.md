...
Import `jest-dom/extend-expect` in your Jest setup file and you're good to go. Make sure to include it using [setupFilesAfterEnv](https://jestjs.io/docs/en/configuration.html#setupfilesafterenv-array).

You only need to add the following line to the setup file:
