...
This allows you to check whether an element is disabled from user's perspective.
It matches if the element is a form element and has or inherits `disabled`
attribute.
